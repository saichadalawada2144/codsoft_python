...
def play_game():
    global user_score, c_score, rounds_left
    ...
    c_score_text.set("Computer's score:"+str(c_score))
    if rounds_left==0:
...
c_score_label=tk.Label(root,textvariable=c_score_text)
c_score_label.pack()
root.mainloop()
